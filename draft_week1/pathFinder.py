...
# Converts incoming frame to HSV format
...
# Detects edges on incoming frame using cv2.Canny()
...
# Crops the image feed and restricts video for lane detection
...
# Forms line segments based on detected edges for processing slope
...
# Returns line segment array defining lane
...
# Returns locus of midpoints of lane boundary
...
# Displays heading line on image based on steering angle value
